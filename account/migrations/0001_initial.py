    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='email adddress')),
                ...
                ('avatar', models.ImageField(blank=True, upload_to='user_avatar/', verbose_name='Аватарка')),
